 ...
 * 		a. 用于访问应用程序组件的Bean工厂方法。{@link继承的org.springframework.beans.factory.ListableBeanFactory}.
 *		b. 以通用方式加载文件资源的能力。从{@link继承org.springframework.core.io.ResourceLoader}接口。
