...
/**
 * 20201212
 * A. {@link BeanPostProcessor}实现，它将ServletContext传递给实现{@link ServletContextAware}接口的bean。
 * B. Web应用程序上下文将自动将其注册到其底层bean工厂。 应用程序不直接使用它。
 */
/**
 * A.
 ...
 */
// 20201212 Servlet上下文自觉BeanPostProcessor
