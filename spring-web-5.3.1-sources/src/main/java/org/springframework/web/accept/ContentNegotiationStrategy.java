...
public interface ContentNegotiationStrategy {
	 ...
	 * @since 5.0.5
	 */
	// 20201223 当不要求特定媒体类型时，从{@link #resolveMediaTypes}返回的带有{@link MediaType＃ALL}的单例列表。
	 ...
	 *
	 * // 20201223 所请求的媒体类型；如果未请求，则为{@link #MEDIA_TYPE_ALL_LIST}。
