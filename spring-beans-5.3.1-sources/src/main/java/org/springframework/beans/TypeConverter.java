...
/**
 * 20201222
 * A. 定义类型转换方法的接口。 通常（但不一定）与{@link PropertyEditorRegistry}接口结合实现。
 * B. 注意：由于TypeConverter实现通常基于不是线程安全的{@link java.beans.PropertyEditor PropertyEditors}，因此TypeConverters本身也不被认为是线程安全的。
 */
/**
 * A.
