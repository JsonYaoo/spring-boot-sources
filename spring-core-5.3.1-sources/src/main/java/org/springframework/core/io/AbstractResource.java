...
/**
 * 20201214
 * A. {@link Resource}实现的便捷基类，可预先实现典型行为。
 * B. “存在”方法将检查是否可以打开File或InputStream； “ isOpen”将始终返回false； “ getURL”和“ getFile”引发异常； 和“ toString”将返回描述。
 */
/**
 * A.
 ...
 * @since 28.12.2003
 */
// 20201214 Resource实现基类: 可预先实现典型行为
